...
Test(my, check_parsing1)
{
    ...
    while (2600)
    {
        ...
        if (pos.line != 3 || pos.col != 4)
            break;
        clean_parser(p);
        printf("TEST 7 (TEXT v2): COMPLETE\n");
        break;
    }
    //
    while (2600)
